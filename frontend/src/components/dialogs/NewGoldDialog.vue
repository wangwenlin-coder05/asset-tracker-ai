...
const feeHint = computed(() => {
  if (form.name.includes('\u5efa\u884c')) return '\u5efa\u884c\u79ef\u5b58\u91d1\uff1a\u4e70\u5165\u624b\u7eed\u8d39\u56fa\u5b9a 4 \u5143'
  if (form.name.includes('\u6d59\u5546')) return '\u6d59\u5546\u79ef\u5b58\u91d1\uff1a\u4e70\u5165\u624b\u7eed\u8d39 0 \u5143'
  return '\u672a\u5339\u914d\u56fa\u5b9a\u89c4\u5219\uff0c\u53ef\u624b\u52a8\u586b\u5199\u624b\u7eed\u8d39'
})
watch(() => form.name, applyFeeRule, { immediate: true })
function applyFeeRule() {
  if (form.name.includes('\u5efa\u884c')) form.fee = 4
  else if (form.name.includes('\u6d59\u5546')) form.fee = 0
}
...
async function handleConfirm() {
  ...
  emit('confirm', {
    ...
    board: 'gold',
    cost: form.buyPrice,
    initialBuyRecord: { buyDate: form.buyDate, buyPrice: form.buyPrice, buyCount: form.buyCount, commission: form.fee }
  })
}
</script>
